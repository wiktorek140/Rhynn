...
public class FWGMessageIDs {
	...
	public static final int MSGID_SYSTEM_CHAT = 64;
	public static final int MSGID_SYSTEM_PING = 65;
	public static final int MSGID_TEST_OBJECT_MOVE = 520;
	public static final int MSGID_TEST_PAYLOAD = 521;
	public static final int MSGID_TEST_REGISTER_LISTENER = 530;
	public static final int MSGID_GAME_PING = 1024;
	public static final int MSGID_GAME_PONG = 1025;
	public static final int MSGID_GAME_DEBUG = 1026;
